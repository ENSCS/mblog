...
- **โครงสร้างไฟล์**
  ...
  - `settings.php` — หน้าแอดมินตั้งค่าเว็บ (ยังไม่ล็อกอินก่อนเข้าได้ — รอ Phase 3) — `require config.php` ตรงๆ ไม่ผ่าน `includes/articles.php` เหมือนหน้าอื่น เพราะไม่ใช้ฟังก์ชันบทความเลยสักตัว
